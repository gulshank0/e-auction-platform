...
<p className="text-4xl font-bold text-center pt-3">Linux Guy</p>
              ...
              <div className="flex space-x-4 pt-3 justify-center">
                <a href="https://x.com/gulshank0" target="_blank" rel="noopener noreferrer" title="Follow on Twitter">
                  <Twitter className="cursor-pointer" />
                </a>
                <a href="https://github.com/gulshank0" target="_blank" rel="noopener noreferrer" title="Visit GitHub Profile">
